...
const fetchMyIP = function(callback) {
  ...
  request(address, function(error, response, body) {
    ...
    if (data) {
      callback(null, data.ip); // { ip: "xxx.xxx.xxx.xxx"}
    }
  });
};
...
const fetchISSFlyOverTimes = function(coords, callback) {
  //  console.log('coords:', `http://api.open-notify.org/iss-pass.json?lat=${coords.latitude}&lon=${coords.longitude}`z);
...
const nextISSTimesForMyLocation = function(callback) {
  fetchMyIP((error, ip) => {
    ...
    // console.log(ip) { ip: "xxx.xxx.xxx.xxx"}
